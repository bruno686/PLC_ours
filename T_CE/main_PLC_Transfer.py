...
model_1 = lightgcn.LightGCN(user_num, item_num, train_adj, args.factor_num, args.num_layers)
model_2 = lightgcn.LightGCN(user_num, item_num, train_adj, args.factor_num, args.num_layers)
